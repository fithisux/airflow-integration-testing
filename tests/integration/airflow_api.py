...
class AirflowAPI:
    def __init__(self):
        self.api_url = f"http://localhost:8080/api/v1"

        airflow_admin_username = 'airflow' #os.getenv("AIRFLOW_ADMIN_USERNAME")
        airflow_admin_password = 'airflow' #os.getenv("AIRFLOW_ADMIN_PASSWORD")
